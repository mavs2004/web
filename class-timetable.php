            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="dropdown">
                       ...
                       <li><a href="/bmi-calculator.php">Calculate BMI</a></li>
                        <li><a href="./team.php">Our team</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="table-controls">
                        <ul>
                            <li class="active" data-tsfilter="all">january</li>
                            <li data-tsfilter="fitness">february</li>
                            <li data-tsfilter="motivation">march</li>
                            <li data-tsfilter="workout">april</li>
                            <li data-tsfilter="fitness">may</li>
                            <li data-tsfilter="motivation">june</li>
                            <li data-tsfilter="workout">july</li>
                            <li data-tsfilter="fitness">august</li>
                            <li data-tsfilter="motivation">september</li>
                            <li data-tsfilter="workout">october</li>
                            <li data-tsfilter="fitness">november</li>
                            <li data-tsfilter="motivation">december</li>
                        </ul>
                    </div>
                </div>
            </div>
