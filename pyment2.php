...
try {
    ...
    if (!$class) {
        throw new Exception("6-month membership class not found in database");
    }
} catch (Exception $e) {
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-body">
                        <h3 class="card-title text-center mb-4">6-Month Membership Payment</h3>
                            ...
                            <div class="col-md-6">
                                <div class="gcash-info">
                                    ...
                                    <ol>
                                        ...
                                        <li>Amount: ₱<?php echo isset($class) ? number_format($class['price'], 2) : '3000.00'; ?></li>
                                        <li>Save the 13-digit reference number from your transaction</li>
                                    </ol>
                                </div>
                                
                                <form method="post" class="payment-form" id="paymentForm">
                                    <input type="hidden" name="class_id" value="<?php echo isset($class) ? $class['class_id'] : 2; ?>">
                                    <div class="mb-3">
