...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/srvs.jpg">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-lg-2 col-md-6 p-0">
                    <div class="ss-text">
                        ...
                        <p>I’ll keep you motivated, ensure proper form, and push you to succeed. A gym membership gives you the tools; I’ll help you use them right. Let’s make it happen—join today!</p>
                ...
                <div class="col-lg-3 order-lg-4 col-md-6 p-0">
                    <div class="ss-text">
                        ...
                        <p>Get fit, have fun, and stay motivated with high-energy group fitness classes!</p>
                ...
                <div class="col-lg-3 order-lg-5 col-md-6 p-0">
                    <div class="ss-text second-row">
                        ...
                        <p>Whether you're a beginner or a seasoned lifter, we’ll help you lift smarter and see real results. Join now and feel the difference!</p>
