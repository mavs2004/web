...
try {
    ...
    if (!$class) {
        throw new Exception("3-months membership class not found in database");
    }
} catch (Exception $e) {
                            ...
                            <div class="col-md-6">
                                <div class="gcash-info">
                                    ...
                                    <ol>
                                        ...
                                        <li>Amount: ₱<?php echo isset($class) ? number_format($class['price'], 1) : '3000.00'; ?></li>
                                        <li>Save the 13-digit reference number from your transaction</li>
                                    </ol>
                                </div>
                                
                                <form method="post" class="payment-form" id="paymentForm">
                                    <input type="hidden" name="class_id" value="<?php echo isset($class) ? $class['class_id'] : 1; ?>">
                                    <div class="mb-3">
