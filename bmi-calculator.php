            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="chart-calculate-form">
                        <p>A BMI (Body Mass Index) Calculator is a tool that helps individuals assess whether their weight is in a healthy range relative to their height. 
                            It provides a quick estimate of body fat based on a simple mathematical formula and categorizes the result into different weight statuses.</p>
                        <form id="bmiForm">
                            <div class="row">
                                <div class="col-sm-6">
                        ...
                        <div id="bmiResult" class="bmi-result">
                            <div class="bmi-value">Your BMI: <span id="bmiValue">0</span></div>
                            <div class="bmi-category">Category: <span id="bmiCategory">-</span></div>
                        </div>
                    </div>
                </div>
            </div>
